...
from Water_Distribution_Attacks import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Water_Distribution_Attacks/$', remoteuser.Predict_Water_Distribution_Attacks, name="Predict_Water_Distribution_Attacks"),
    ...
    url(r'^View_Predicted_Water_Distribution_Attacks_Type_Ratio/$', serviceprovider.View_Predicted_Water_Distribution_Attacks_Type_Ratio, name="View_Predicted_Water_Distribution_Attacks_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Water_Distribution_Attacks_Type/$', serviceprovider.View_Predicted_Water_Distribution_Attacks_Type, name="View_Predicted_Water_Distribution_Attacks_Type"),
